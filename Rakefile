...
base_files = %w{intro core support data queue attributes event selector traversing manipulation css ajax xhr transports/jsonp transports/script transports/xhr transports/xdr effects offset dimensions outro}.map { |js| File.join( src_dir, "#{js}.js" ) }
