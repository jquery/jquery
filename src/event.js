...
jQuery.event = {
	...
	add: function( elem, types, handler, data ) {
		...
		if ( typeof events === "function" ) {
			...
			// the function does not need to be called, it just contains
			// the data
			eventHandle = events.handle;
			events = events.events;
		} else if ( !events ) {
			if ( !elem.nodeType ) {
				// on plain objects, create a fn that acts
				// as the holder of the values to avoid JSON
