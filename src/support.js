...
jQuery.support = (function() {
	...
	testElement.style.backgroundImage = "url('foo.png')";
	testElement.cloneNode( true ).style.backgroundImage = "";
	support.cloneBackgroundFix = testElement.style.backgroundImage === "";
