/*!
 * jQuery JavaScript Library v4.0.0-pre slim
 * https://jquery.com/
 *
 ...
 *
 * Date: 2022-09-21T16:25Z
 */

// For environments where a proper `window` is present, execute the factory
// and get jQuery. For environments that do not have a `window` with
// a `document` (such as Node.js), export a factory. This accentuates the need
// for the creation of a real `window`, e.g.:
//
// ```js
...
var defaultExport = typeof window !== "undefined" && window.document ?
