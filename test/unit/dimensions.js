...
QUnit.test("innerWidth()", function( assert ) {
	...
	assert.equal(jQuery(window).innerWidth(), winWidth, "Test on window");
	assert.equal(jQuery(document).innerWidth(), docWidth, "Test on document");
...
QUnit.test("outerWidth()", function( assert ) {
	...
	assert.equal( jQuery( document ).outerWidth(), docWidth, "Test on document without margin option" );
	assert.equal( jQuery( document ).outerWidth( true ), docWidth, "Test on document with margin option" );
...
QUnit.test( "table dimensions", 2, function( assert ) {
...
testIframe( "dimensions/documentLarge", "window vs. large document", function( jQuery, window, document ) {
	...
	QUnit.assert.ok( jQuery( document ).height() > jQuery( window ).height(), "document height is larger than window height" );
	QUnit.assert.ok( jQuery( document ).width() > jQuery( window ).width(), "document width is larger than window width" );
});
