...
test( "override style='x: y !important;' when changing styles", function() {
	expect( 1 );
	var el = jQuery( "<div style='display: block !important;'></div>" );
	equal( el.css( "display", "none" ).css( "display" ), "none" );
});
