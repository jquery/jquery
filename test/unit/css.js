...
test("can't get css for disconnected in IE<9, see #10254 and #8388", function() {
	expect( 2 );
	var span = jQuery( "<span/>" ).css( "background-image", "url(http://jsfiddle.net/img/logo.png)" );
	equal( span.css( "background-image" ), "url(http://jsfiddle.net/img/logo.png)", "can't get background-image in IE<9, see #10254" );
