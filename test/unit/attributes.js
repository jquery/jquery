...
QUnit.test( "prop('tabindex', value)", 10, function( assert ) {
...
var testVal = function( assert, valueObj ) {
	expect( 9 );
...
QUnit.test( "val(String/Number)", function( assert ) {
	testVal( assert, bareObj );
});

QUnit.test( "val(Function)", function( assert ) {
	testVal( assert, functionReturningObj );
});
...
var testAddClass = function( assert, valueObj ) {
	expect( 9 );
...
QUnit.test( "addClass(String)", function( assert ) {
	testAddClass( assert, bareObj );
});

QUnit.test( "addClass(Function)", function( assert ) {
	testAddClass( assert, functionReturningObj );
});
...
var testRemoveClass = function( assert, valueObj ) {
	expect( 8 );
...
QUnit.test( "removeClass(String) - simple", function( assert ) {
	testRemoveClass( assert, bareObj );
});

QUnit.test( "removeClass(Function) - simple", function( assert ) {
	testRemoveClass( assert, functionReturningObj );
});
...
var testToggleClass = function( assert, valueObj ) {
	expect( 17 );
...
QUnit.test( "toggleClass(String|boolean|undefined[, boolean])", function( assert ) {
	testToggleClass( assert, bareObj );
});

QUnit.test( "toggleClass(Function[, boolean])", function( assert ) {
	testToggleClass( assert, functionReturningObj );
});
...
QUnit.test( "should not throw at $(option).val() (#14686)", 1, function( assert ) {
	try {
		jQuery( "<option/>" ).val();
		assert.ok( true );
	} catch ( _ ) {
