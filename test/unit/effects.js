...
test( "timers cleanup race condition", function() {
	...
	setTimeout( function() {
		equal( animated1.css( "display" ), "block", "1st element expected display: block" );
		equal( animated2.css( "display" ), "none", "2nd element expected display: none" );
		equal( animated3.css( "display" ), "none", "3rd element expected display: none" );
		start();
	}, 150 );
});
