...
test( "end()", function() {
	...
	var chain = jQuery( "#qunit-fixture" ).children( "div" ).find( "p" ).find( "code" ).find( "a" );
	
	equal( chain.end( 0 ), chain.end(), "Check end( 0 ) vs end()" );
	equal( chain.end( -2 ), chain.end().end().end().end(), "Check end()-2 vs end()" );
	equal( chain.end( 0 ), chain.end(), "Check end( 0 ) vs end()" );
	equal( chain.end( 0 ), chain.end(), "Check end( 0 ) vs end()" );
