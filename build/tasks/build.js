...
module.exports = function( grunt ) {
	...
	function() {
		var flag, index,
			 ...
			 * @param {String} flag A module path relative to the src
			 *                      directory starting with + or - to
			 *                      indicate whether it should included or excluded
			 */
		...
		//  *:*:-css:+effects  same (excludes effects because explicit
		//						include is trumped by explicit exclude of dependency)
